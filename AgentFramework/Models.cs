...
public class ModelsPlugin
{
  ...
  [Description("Get the name for a given product SKU")]
  ...
  [Description("Get the range in miles for a given product SKU")]
  ...
  [Description("Get the length in metres for a given product SKU")]
  ...
  [Description("Get the colour for a given product SKU")]
