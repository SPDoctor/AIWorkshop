...
public class CalcPlugin
{
  ...
  [Description("Subtract one number from another number")]
  ...
  [Description("Raise one number to the power of another number")]
  ...
  [Description("Take the nth root of a number")]
